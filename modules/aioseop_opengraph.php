		...
		function __construct( ) {
			...
			$this->default_options = array(
					...
					'twitter_site'	=> Array(	'name'			=> __( 'Twitter Site', 'all-in-one-seo-pack' ),
												'type'			=> 'text', 'default' => '' ),
					'twitter_creator'=>Array(	'name'			=> __( 'Show Twitter Author', 'all-in-one-seo-pack' ), 'default' => 1 ),
					...
					'facebook_author'	=>Array('name'			=> __( 'Show Facebook Author on Articles', 'all-in-one-seo-pack' ),'default' => 1),
